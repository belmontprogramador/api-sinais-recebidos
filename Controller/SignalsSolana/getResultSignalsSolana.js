...
// Rota HTTP
const getResultSignalSolana = async (req, res) => {
  try {
    const results = await getSolanaResults();
    ...
    res.status(500).json({ error: 'Erro ao obter dados dos sinais de Solana.' });
  }
};
...
module.exports = getResultSignalSolana;
